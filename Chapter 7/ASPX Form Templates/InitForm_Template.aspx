...
<%-- _LocalBinding --%>
<%@ Assembly Name="Step 1: Assembly Strong Name"%>
<%@ Page Language="C#" EnableSessionState="true" ValidateRequest="False"  Inherits="Step 2: Namespace.Classname"
...
<!--Step 3: Form Controls.  Name and type must match entries in WFDataPages.cs
ex:
        <input type="text" name="TrafficCoordinator" id="TrafficCoordinator" runat="server" />
-->
